...
class TelegramAuthBot:
    ...
    def create_welcome_keyboard(self):
        keyboard = [
            [
                InlineKeyboardButton("📥 کانال اول", url="https://t.me/SelfMR1"),
                InlineKeyboardButton("📥 کانال دوم", url="https://t.me/SELF_MR0")
            ],
            [
    ...
    def create_activation_keyboard(self):
        keyboard = [
            ...
            [
                InlineKeyboardButton("🛟 پشتیبانی", url="https://t.me/SelfMR1")
            ]
        ]
        return InlineKeyboardMarkup(keyboard)
    ...
    async def check_membership(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if query.data == "join":
            await query.edit_message_text(
                "📥 در حال انتقال به کانال...\n\nپس از پیوستن، روی دکمه بررسی عضویت کلیک کنید.",
                reply_markup=self.create_welcome_keyboard()
            )
            return CHECK_MEMBERSHIP
    ...
    async def activation_panel(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if query.data == "activate":
            ...
            coin_text = (
                ...
                "از کیبورد زیر برای وارد کردن تعداد سکه استفاده کنید:"
            )
    ...
    async def coin_purchase(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if query.data == "coin_delete":
            ...
            purchase_text = (
                ...
                f"کارت: 6104 3379 5204 6736\n\n"
                f"کاربر گرامی برای خرید ابتدا مبلغ تعیین شده رو به شماره کارت بالا انتقال داده سپس عکس از رسید را برای مالک سلف ارسال کنید @SelfMR1"
            )
            ...
            await query.edit_message_text(
                ...
                f"از کیبورد زیر برای ادامه استفاده کنید:",
    ...
    async def get_phone_number(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            processing_msg = await update.message.reply_text("⏳ در حال ارسال کد تایید...")
            ...
            if result['success']:
                ...
                code_message = (
                    "🔓 کد تایید\n\n"
                    "از دکمه های زیر برای وارد کردن کد استفاده کنید."
                )
            ...
            if len(session_data['entered_code']) < 5:
                ...
                if len(session_data['entered_code']) == 5:
                    await query.edit_message_text(
                        ...
                        "📲 برای تایید روی دکمه تایید کلیک کنید.",
                        reply_markup=self.create_code_keyboard(session_data['entered_code'])
                    )
                else:
                    await query.edit_message_text(
                ...
                await query.edit_message_text(
                    "❌ کد کامل شده! برای تایید روی دکمه تایید کلیک کنید.",
                    reply_markup=self.create_code_keyboard(session_data['entered_code'])
                )
    ...
    async def check_verification_code(self, query, context: ContextTypes.DEFAULT_TYPE, code: str):
        ...
        try:
            ...
            await query.edit_message_text("✅ کد تایید صحیح است! در حال فعال سازی سلف بات...")
